...
https://docs.google.com/document/d/15GuwZwIOQy_g1XsIJjQsFNHCTQTWoXQhWGVMhiH0swc/edit?usp=sharing 
...
🚀 How to Use
  ...
  # 2. Setup LinkedIn session (one-time)
  ...
  # 4. Start monitoring
  python engine/watcher_linkedin.py

  # 5. Generate first post
  python engine/linkedin_post_generator.py

  Daily Usage

  Terminal 1: Main Automation
  python run_automation.py

  Terminal 2: LinkedIn Monitoring
  python engine/watcher_linkedin.py

  That's it! The system now:
  - Monitors LinkedIn messages automatically
  - Generates post drafts with Qwen
  ...
  Scenario: Client Inquiry → Post Generation → Lead Generation        

  Step 1: Client sends LinkedIn message
  "Hi, I'm interested in your AI automation services.
  Can you send me pricing information?"

  Step 2: Watcher detects (5 minutes)
  📨 New message from John Doe (URGENT)
  ✅ Created task: LINKEDIN_MSG_John_Doe.md

  Step 3: Qwen analyzes
  🤖 Qwen is processing...
  ✅ Task analysis completed

  Step 4: Qwen generates post
  🤖 Generating service promotion post...
  ✅ Post created in Pending Approval/

  Step 5: You review and approve
  Move file to Approved/ folder

  Step 6: Auto-published
  📝 Creating LinkedIn post...
  ✅ LinkedIn post published successfully!

  Step 7: Results
  - Original inquiry answered
  - Post attracts 5 more similar inquiries
  - Business growth! 🚀
